        ...
        >
          <div className="overflow-hidden mb-4">
            <motion.p
              ...
              data-editable="text"
              data-prop='@file[data/pages/home/hero.json].pretitle'
            >
              {heroCopy.pretitle}
            </motion.p>
          </div>
          ...
          <h1 className="text-5xl md:text-7xl lg:text-9xl font-bold tracking-tighter text-white mb-6 leading-[0.95]">
            <motion.span
              ...
              className="block"
              data-editable="text"
              data-prop='@file[data/pages/home/hero.json].title'
            >
              {heroCopy.title}
            </motion.span>
            <motion.span
              ...
              data-editable="text"
              data-prop='@file[data/pages/home/hero.json].subtitle'
            >
              {heroCopy.subtitle}
            </motion.span>
          </h1>
          ...
          <motion.p
            ...
            data-editable="text"
            data-prop='@file[data/pages/home/hero.json].description'
          >
          ...
          <motion.div variants={fadeUp} className="flex flex-wrap gap-4">
            <button
              ...
              data-editable="text"
              data-prop='@file[data/pages/home/hero.json].ctaPrimary'
            >
              {heroCopy.ctaPrimary}
            </button>
          </motion.div>
