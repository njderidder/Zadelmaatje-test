      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full mt-20">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-9xl font-bold tracking-tighter text-white mb-6 leading-[0.95]">
            <motion.span variants={fadeUp} className="block">{HERO_COPY.title}</motion.span>
            <motion.span variants={fadeUp} className="block text-white/70 italic font-serif">{HERO_COPY.subtitle}</motion.span>
          </h1>
          ...
          <motion.div variants={fadeUp} className="flex flex-wrap gap-4">
            <button className="bg-brand-accent text-white px-8 py-4 rounded-md font-bold uppercase tracking-widest hover:bg-white hover:text-brand-dark transition-all duration-300 shadow-lg hover:shadow-brand-accent/20">
